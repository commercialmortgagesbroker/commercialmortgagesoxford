/**
 * Blog launch slate, Commercial Mortgages Oxford.
 *
...
export const blogPosts: BlogPost[] = [
  {
    slug: "oxford-commercial-property-market",
    title: "The Oxford commercial property market in 2026",
    excerpt:
      "A working read on the Oxford commercial property market at mid-2026. The CBD office story (Westgate, Westgate). The Eastern Bypass corridor industrial corridor (Cowley, Cowley East, Eastern Bypass). The four semi-commercial spines (Cowley Road, High Street, High Street, Witney Road). The Headington and North Oxford care-home cluster. The trading-business pipeline. The 90-strong lender pool that funds it. Plus a rates and BoE-trajectory view into 2027.",
    content: "See /oxford-commercial-property-market for the full editorial article. This entry exists so the blog index can surface the flagship piece.",
    image: "/images/blog-oxford-market-2026.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-05-11",
    category: "Market Read",
    tags: ["oxford", "commercial property", "2026", "market read", "flagship"],
    localStats: [
      { stat: "Oxford economy: £64.6bn", source: "Oxford City Region LEP" },
      { stat: "Oxford GVA: £18.8bn", source: "ONS sub-national indicators" },
      { stat: "Active companies in Oxford: 109,000+", source: "Oxford City Council" },
      { stat: "Office stock: 11M sqft", source: "Oxford City Region economic assessment" },
      { stat: "Mid-2026 CM rate range: 6.0–9.0% pa", source: "Broker panel, May 2026" },
    ],
  },

  {
    slug: "commercial-mortgage-rates-oxford-rest-of-2026",
    title: "Commercial mortgage rates in Oxford: what to expect for the rest of 2026",
    excerpt:
      "A view on where Oxford commercial mortgage pricing sits at mid-2026 and where it is likely to land by year-end. Owner-occupier 6.0–7.5% pa, commercial investment 6.5–8.5%, semi-commercial up to 9.5%, trading-business up to 10%. Plus the BoE base rate trajectory, swap-curve direction, and named lender appetite where the broker has confirmed permission.",
    content: `Commercial mortgage rates in Oxford for mid-2026 sit broadly between 7.0% and 10.0% per annum across the eight mainstream product types. Where exactly your deal prices depends on product, sector, LTV, covenant strength, term length and the specific lender desk. This piece sets out the actual rate ranges I am placing this quarter, with named lender positioning where I have confirmed permission to name them, and a working view of where pricing is likely to land for the rest of 2026.

## The macro setting at mid-2026

The Bank of England base rate has held flat through the first half of 2026 after the cuts of late 2025. Swap rates, which drive fixed-rate commercial mortgage pricing more directly than base rate, have ticked sideways for nine months. The 5-year SONIA swap, which most Oxford challenger banks anchor 5-year commercial mortgage fixes to, has traded in a tight band of 4.20 to 4.55%. Lender margins on top sit between 280 and 450 basis points depending on product, LTV and covenant.
...
Investment commercial mortgages on let assets currently price 7.5 to 9.0% pa across the panel. Strong-covenant single-let assets with 10-year FRI leases price at the lower-cover end, Shawbrook quotes 7.5 to 7.8% pa at 60 to 65% LTV on a Westgate office let to a national professional services firm. Multi-let or short-lease assets at 75% LTV price wider, InterBay Commercial, Cynergy Bank or LendInvest typically pick these up at 8.5 to 9.0% pa.

ICR cover at 140 to 160% stressed is the binding test, not headline LTV. Tenant covenant matters as much as rent: a 10-year unbroken FRI lease to an investment-grade tenant prices materially better than three two-year leases to local independents at the same gross rent number. Two practical implications for Oxford investors planning Q3-Q4 acquisitions: weight your acquisition criteria toward longer leases even if the rent is keener on short-lease alternatives, and weight toward stronger covenants even if the gross yield is slightly thinner.

## Semi-commercial, 7.5 to 9.5% pa, up to 75% LTV

Semi-commercial pricing on the classic Oxford shop-with-flat-above archetype currently runs 7.5 to 9.5% pa at up to 75% LTV. InterBay Commercial (OSB Group), Together, Aldermore, YBS Commercial and HTB Oxford all quote competitively. The blended ICR test, combining commercial rent and AST income at around 145%, is the binding constraint.

Active Oxford semi-commercial spines worth knowing: Cowley Road and Walton Crescent in Jericho, Witney Road in Summertown, High Street in Marston, High Street in Littlemore, Headington village. Most deals are £150K to £800K facility size. The FCA twist on semi-commercial, where 40% or more of floor area is residential and the borrower or family lives in part of the property, the loan can fall inside the FCA regulated mortgage perimeter, needs careful handling. We screen for this on the first call.
...
- **MOT and forecourt:** 8.5 to 9.5% pa at 60 to 70% LTV. Together dominates the Oxfordshire MOT and garage market.
...
Portfolio refinance for five-or-more asset commercial investment portfolios runs 7.5 to 9.0% pa at 65 to 70% aggregated LTV. Shawbrook, Cambridge & Counties, InterBay Commercial and Cynergy Bank dominate the £2M to £15M Oxford bracket. OakNorth and Reliance Bank cover larger.
...
LendInvest, Shawbrook, Together, OakNorth and Hampshire Trust Bank are the most active bridge-to-let lenders for the Oxford £500K to £5M bracket.
...
[Contact us](/contact) to discuss your Oxford commercial mortgage, or use the [calculator](/calculator) for an indicative monthly repayment.

*Rate ranges quoted reflect the Oxford commercial mortgage market in May 2026. Actual offers depend on individual deal characteristics. Ranges and named lender positioning may move quarter on quarter, this piece is updated quarterly.*`,
    image: "/images/blog-rates-2026.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-05-10",
    category: "Market Update",
    tags: ["rates", "oxford", "commercial mortgage", "2026", "market update"],
    localStats: [
      { stat: "Mid-2026 Oxford CM rate range: 6.0–9.0% pa", source: "Broker panel data, May 2026" },
      { stat: "Active lender count on Oxford CM panel: 90+", source: "Broker panel" },
...

  {
    ...
    excerpt:
      "The single most common mistake I see on Oxford commercial mortgage enquiries is the wrong product applied for. An owner-occupier wanting a freehold for the business is not the same case as an investor buying a let asset, and the lender pool, the underwriting tests, the LTV and the rate range are all different. This piece untangles the two, when the line blurs (group structures, sale-and-leaseback, family lets), how lenders look at each, and how to match your case to the right product on day one. We walk through three real-shape Oxford examples, a Jericho dental practice freehold, a Westgate office acquisition let to the buyer's own group company, and a Headington shop with three flats above where the buyer's son lives in flat 1. Each one points at a different product, a different lender desk and a different underwrite.",
    content: `The single most common mistake we see on Oxford commercial mortgage enquiries is the wrong product applied for. An owner-occupier buying premises for their business is not the same case as an investor buying a let asset, and the lender pool, the underwriting tests, the LTV ceiling and the rate range are all different. Get this wrong on day one and you waste four weeks at the wrong desk before the credit committee tells you what we could have told you on the first call.

This piece sets out the headline test, walks through how each product is actually underwritten, deals with the grey zone (group structures, sale-and-leaseback, family lets), and works three real-shape Oxford examples that each point at a different product.
...
| Product | Active panel for Oxford £400K–£5M | LTV ceiling | Rate range (mid-2026) |
|---|---|---|---|
...
## Three Oxford worked examples

### Example 1: Jericho dental practice freehold (owner-occupier)

Two-partner NHS-mixed dental practice on Cowley Road, OX2, buying the freehold of the corner premises they currently rent. Purchase price £680,000, deposit £170,000 (25%), loan £510,000 over 20 years on a 5-year fix.
...
### Example 2: Westgate office let to the buyer's group company (investment with owner-occupier overlay)

Professional services group buying a 6,200 sqft floor at Westgate, OX1, into a freshly incorporated SPV. The SPV grants a 15-year FRI lease back to the trading subsidiary at a market rent of £155,000 pa. Purchase price £2.1M, loan £1.47M at 70% LTV.
...
### Example 3: Headington shop with three flats, family in flat 1 (regulated route)

OX3, parade off Street Lane. Ground-floor retail let to an established independent, three flats above. Flat 1 is currently let to the borrower's adult son on an AST at market rent. Flats 2 and 3 are open-market ASTs.
...
If you are looking at a Oxford commercial purchase or refinance and you are not sure which side of the line your case sits on, send us the headline numbers and the occupancy position. We will tell you on the first call which product fits, which desks to approach, and whether anything in the structure needs to change before submission.

[Contact us](/contact) to talk through your case.

For the wider lender network and how the Oxford desk sits inside it, see the [Oxford page on Commercial Mortgages Broker](https://commercialmortgagesbroker.co.uk/locations/oxfordshire/oxford).`,
    image: "/images/blog-owner-occupier-vs-investment.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-05-24",
    category: "Guide",
    tags: ["owner occupier", "investment", "oxford", "guide", "commercial mortgage"],
    localStats: [],
  },

  {
    slug: "dscr-icr-explained-oxford-examples",
    title: "How DSCR and ICR actually work, explained with real Oxford examples",
    excerpt:
      "Every lender quote on a commercial investment mortgage tests one of two cover ratios, ICR (interest cover ratio) or DSCR (debt-service coverage ratio). Get the test wrong and the offer prices down at credit committee, or falls over completely. This piece walks through both ratios using real-shape Oxford investment deals: a Westgate office let on FRI, a Jericho shop-with-flats parade, a four-asset Headington portfolio, and a Westgate mixed-use block. We work the numbers at pay rate and at stressed rate, show where each lender sets the threshold, and explain how to engineer the structure (term length, LTV step-down, fixed vs tracker) so the case clears comfortably rather than scraping over.",
    content: `Every lender quote on a commercial investment mortgage tests one of two cover ratios. ICR (interest cover ratio) or DSCR (debt-service coverage ratio). Get the test wrong on the indicative model and the offer prices down at credit committee, or falls over entirely. This piece walks through both ratios using real-shape Oxford investment deals, works the numbers at pay rate and at stressed rate, and shows where each lender sets the threshold.
...
## Worked example 1: Westgate single-let office (ICR)

OX1, 8,400 sqft Grade A floor at Westgate. Let to a national professional services firm on a 10-year FRI lease, gross rent £210,000 pa, three years unexpired at indicative-terms stage with a tenant option to renew.
...
## Worked example 2: Jericho semi-commercial parade (blended ICR)

OX2, Cowley Road parade. Three units, each with a flat above. Retail rent £58,000 pa combined, residential AST income £42,000 pa combined. Gross blended rent £100,000 pa.
...
## Worked example 3: Headington 4-asset portfolio (DSCR)

OX3, four mid-market investment assets: two retail units, one office, one industrial. Aggregate rent £285,000 pa, weighted average lease term 6.2 years.
...
## Worked example 4: Westgate mixed-use block (DSCR with residential blend)

OX2, Westgate. Five-storey block, ground-floor commercial (cafe and shop), four floors of residential ASTs (12 flats total). Commercial rent £58,000 pa, residential gross £168,000 pa. Total £226,000 pa.
...
Indicative thresholds across the active Oxford investment desks at mid-2026, useful for sanity-checking which desks your deal is even worth approaching.
...
On most Oxford semi-commercial and mixed-use deals at mid-2026, the cover test caps the loan well inside the headline LTV ceiling. Build that into the model from day one.

## Send us the deal

If you are modelling a Oxford commercial investment purchase or refinance and want the cover test run at indicative-terms stage before you commit to a loan size, send the rent roll, lease details and target loan amount. We will run ICR and DSCR at pay rate and at stressed rate across three to five lender thresholds inside 48 hours, so you know what is actually fundable.

[Contact us](/contact) to discuss your investment case.

For the wider commercial investment lender panel and how the Oxford desk plugs into it, see the [Oxford page on Commercial Mortgages Broker](https://commercialmortgagesbroker.co.uk/locations/oxfordshire/oxford).`,
    image: "/images/blog-dscr-icr.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-06-07",
    category: "Guide",
    tags: ["DSCR", "ICR", "investment", "oxford", "underwriting"],
    localStats: [],
  },

  {
    slug: "care-home-commercial-mortgages-cqc-oxford",
    title: "Care home commercial mortgages in Oxford: CQC ratings, lender appetite and what actually funds",
    excerpt:
      "Oxford has an unusually strong cluster of premium care home stock through the OX3 and OX17 corridor, Headington, North Oxford, Summertown, and the lender appetite for the right asset has held up well into 2026. But the CQC rating is the gating factor, and the gap between Outstanding, Good and Requires Improvement is the difference between a 70% LTV at 8.0% pa and not getting a quote at all. This piece sets out which specialist desks are quoting actively (Shawbrook, Cambridge & Counties, Hampshire Trust Bank), what occupancy and fee mix they expect to see, how the goodwill versus bricks-and-mortar valuation split works in practice, and what to do if a re-inspection is due before completion.",
    content: `Oxford has one of the strongest premium care home clusters in the North of England. The OX3 and OX17 corridor (Headington, North Oxford, Summertown, Summertown) holds a concentration of mid-size private-pay and mixed-funded homes that have traded well through 2025 and into 2026. Lender appetite for the right asset has held up, but the CQC rating is the gating factor, and the gap between Outstanding, Good and Requires Improvement is the difference between a 70% LTV at 8.0% pa and not getting an offer at all.
...
## The Oxford care home market: OX3/OX17 premium cluster

The market splits into three clear price tiers locally. Premium private-pay homes through North Oxford (OX17) and parts of Headington (OX3) trade on EBITDA multiples of 7 to 9 times for Good and Outstanding-rated stock, with bed counts typically 30 to 60. Mid-tier mixed-funded homes through East Oxford and Cowley (OX2/OX3) sit at 5 to 7 times EBITDA. Older converted stock, often Victorian large houses, trades down at 4 to 5 times where it trades at all.
...
For a 42-bed home in OX17 currently at 90% occupancy with a TTM of 88%, that data shape is exactly what **Shawbrook**'s healthcare desk wants to see at indicative-terms stage.

## Fee mix: local authority vs private split

Private-pay weighted homes price keenest. A Headington home running 75% private-pay residents at an average weekly fee of £1,450 reads materially better than a East Oxford home running 25% private-pay at £950 average across the book.

Local authority fees in West Oxfordshire run £780 to £920 per week for standard residential care at mid-2026, with nursing top-ups taking that to £950 to £1,100. Private fees in OX3 and OX17 commonly clear £1,400 to £1,800. The gross EBITDA per bed difference is the entire reason premium-cluster stock trades on 8x earnings while mid-tier stock trades on 5x.
...
For Oxford care home freehold transactions at mid-2026, the typical split sits at 60/40 to 65/35 bricks-to-goodwill on Good and Outstanding rated stock. Premium boutique homes in OX17 sometimes split closer to 55/45 because the trading premium is real.
...
For a Good or Outstanding rated Oxford care home in the £2M to £8M facility bracket at mid-2026, four desks should be on the shortlist.

**Shawbrook** healthcare team. Active across Oxfordshire, full going-concern lending, 60 to 70% LTV, 8.0 to 8.5% pa for Outstanding, 8.5 to 9.0% pa for Good.

Cambridge & Counties. Long-standing care home lender, regional underwriter who knows the OX3/OX17 cluster, 60 to 65% LTV with the bricks/goodwill split structure, 8.5 to 9.0% pa.
...
## Worked Headington refinance example

OX3, 38-bed home in Headington, rated Good across all five domains at the last inspection (14 months ago). Occupancy 89% current, 86% TTM. Fee mix 70% private at £1,520 average weekly, 30% local authority at £880 average. Trailing EBITDA £620,000 pa. Going-concern valuation £4.5M (65/35 bricks/goodwill split).
...
If you are looking at a Oxford care home freehold purchase or a refinance and you want indicative terms from the three or four specialist desks that actually fund the OX3 and OX17 cluster, send us the CQC rating, occupancy, fee mix and trailing EBITDA. We will come back inside 48 hours with terms and the practical structure each desk will want.

[Contact us](/contact) to discuss your care home case.

For the national care home lender network behind the Oxford desk, see the [Oxford page on Commercial Mortgages Broker](https://commercialmortgagesbroker.co.uk/locations/oxfordshire/oxford).`,
    image: "/images/blog-care-home.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-06-21",
    category: "Sector Analysis",
    tags: ["care home", "oxford", "CQC", "specialist", "trading business"],
    localStats: [],
  },

  {
    slug: "pub-freehold-purchase-oxford-barrelage-ebitda",
    title: "Pub freehold purchase in Oxford: barrelage, EBITDA and the specialist lender desks",
    excerpt:
      "Buying a pub freehold is one of the most specialist commercial mortgages on the panel. Lenders test barrelage, beer-tie status, food-to-wet revenue split, license type, the operator's track record, and the EBITDA cover before they look at bricks-and-mortar value. This piece walks through what the licensed-trade desks at Cynergy Bank, ASK Partners and the small group of pub-active specialists actually want to see, using the recent Bicester and Marston pub freeholds I have placed as worked examples. Free-of-tie freehold prices significantly tighter than tied; food-led pubs price tighter than wet-led. The piece sets out the rate ranges, the typical LTV ceilings, and where I see the 2026 pub freehold market heading.",
...
This piece walks through how the pub freehold underwrite actually works at mid-2026, with worked examples from recent Bicester and Marston transactions.
...
For Oxford at mid-2026, free-of-tie freehold pricing runs 8.5 to 9.0% pa at 60 to 65% LTV. Tied freeholds, where they appear, sit 9.0 to 9.75% pa.
...
Typical Oxford market barrelage benchmarks at mid-2026:
...
For most clean Oxford free-of-tie pub freeholds in the £500K to £3M bracket, **Cynergy Bank** and ASK Partners are the two desks to lead with.

## Worked example 1: Bicester pub refinance

OX12, free-of-tie food-led freehold in central Bicester. 18-cover restaurant area plus a 40-cover bar, eight letting rooms on the upper floors generating ancillary £85,000 pa. Food-to-wet split 68/32. Barrelage 240 (steady three-year trend). Trailing EBITDA £415,000 pa including the rooms.
...
## Worked example 2: Marston pub freehold purchase

OX18, High Street, Marston. Free-of-tie wet-led community pub, no food offer to speak of, large car park rear. Barrelage 270 (rising trend over three years, new operator improved trade). Food-to-wet 15/85 (essentially wet-led). Trailing EBITDA £165,000 pa.
...
For a clean indicative-terms run on a Oxford pub freehold purchase or refinance, send the following:
...
## The Oxford semi-commercial market: the four spines

Oxford has four distinctive semi-commercial high-street spines that account for most of the £200,000 to £1.5M deal flow.

Cowley Road through Jericho (OX2) and into Far Jericho (OX16). Independent retail, food and drink, dental, opticians, with flats above almost universally. The strongest semi-commercial parade in north Oxford.

High Street through Marston (OX18) and into Marston (OX18). Mixed retail and service trades, with one and two-bedroom flats above. Strong AST market, professional renter demographic.

Witney Road through Summertown (OX2) and Summertown (OX17). The most premium of the four spines, particularly the Summertown village section. Food and drink heavy, with high-quality residential conversion above.

Headington and Headington village (OX3/OX15). Mixed retail and service with traditional shop-with-flat-above stock, often Victorian or Edwardian.
...
For Oxford semi-commercial in the £200,000 to £1.5M facility bracket where the case sits cleanly outside the regulated perimeter, four desks should be on the shortlist.

**InterBay Commercial** (OSB Group). The market-leading desk for Oxford shop-with-flat-above. Up to 75% LTV, blended ICR test, 7.5 to 8.5% pa for clean cases on a 5-year fix.
...
YBS Commercial (Reading HQ, natural Oxford catchment). Up to 75% LTV, conservative ICR treatment, 7.75 to 8.5% pa for strong cases.
...
## Worked Jericho parade example

OX2, Cowley Road parade. Two-unit retail with three flats above, single freehold title. Ground-floor units: a 55 sqm cafe and a 48 sqm independent retailer, both on 5-year FRI leases. Three flats above: one studio (28 sqm), two one-beds (36 sqm and 40 sqm).

Floor-area split: commercial 103 sqm, residential 104 sqm. 50.2% residential, above the 40% threshold.

Buyer is a Oxford-based limited company landlord. No personal occupation, no family-let intent. All three flats currently let to arms-length tenants on standard ASTs. The case is unregulated.
...
- Worked four-asset Headington parade example`,
    image: "/images/blog-portfolio-refinance.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-08-02",
    category: "Guide",
    tags: ["portfolio", "refinance", "oxford", "investment", "consolidation"],
    localStats: [],
  },

  {
    slug: "stamp-duty-commercial-property-oxford-2026-changes",
    title: "Stamp duty on commercial property: the 2026 picture and what is changing",
    excerpt:
      "Stamp Duty Land Tax on commercial property in Oxford and the rest of England runs on three non-residential bands: 0% to £150,000, 2% on the next £100,000, 5% on the balance. There is no first-time-buyer relief, no second-property surcharge, and no annual tax on enveloped dwellings issue. This piece walks through how SDLT is calculated on commercial purchases at typical Oxford price points (£600K shop+flat, £1.7M trading business freehold, £3.7M industrial unit), how mixed-use property is treated, what the 2026 Autumn Budget signalled for the bands, and the most common SDLT mistakes commercial buyers make, including the mixed-use mis-classification trap.",
    content: `Coming soon, full guide to commercial property stamp duty in Oxford.
...
- SDLT and refinancing: when does it apply, when does it not`,
    ...
    tags: ["stamp duty", "SDLT", "tax", "oxford", "commercial property"],
    localStats: [],
  },
...
- Worked example: 4-asset portfolio in Headington
- Worked example: dental practice with property in same limited company`,
  ...
  {
    slug: "commercial-bridging-oxford-when-right-when-not",
    title: "Commercial bridging in Oxford: when it is the right answer, and when it absolutely is not",
    excerpt:
      "Commercial bridging at 0.75 to 1.10% per month is meaningfully more expensive than term commercial mortgage debt at 7.5 to 9.0% pa, but for the right case it is the right answer. Vacant possession purchase below market value, change-of-use light works, sub-12-month exit, chain-break refinancing, all real bridging use cases I see in the Oxford market every month. The wrong cases, using bridging where a clean commercial investment mortgage would fund, or using bridging because the borrower's accounts are not yet ready for term, cost real money and frequently end badly. This piece walks through the case-selection framework, the bridge-to-let exit mechanic, and the active Oxford bridging desks at LendInvest, Shawbrook, Together and Hampshire Trust Bank.",
...
- Active Oxford bridging desks
- Worked example 1: vacant Jericho parade purchase
- Worked example 2: change-of-use Cowley unit
- Worked example 3: chain-break Bicester pub`,
    image: "/images/blog-bridging.png",
    author: "Commercial Mortgages Oxford",
    publishDate: "2026-09-13",
    category: "Guide",
    tags: ["bridging", "bridge to let", "oxford", "guide", "commercial"],
    localStats: [],
  },
];
