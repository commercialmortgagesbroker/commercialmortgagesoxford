...
export const faqItems: FAQItem[] = [
  ...
  {
    question: "How long does it take to arrange a Oxford commercial mortgage?",
  ...
  {
    question: "Which Oxford areas do you cover?",
    slug: "which-areas-do-you-cover",
    answer: `We arrange commercial mortgages across the full Oxford metropolitan area and the wider Oxfordshire footprint. Twelve area pages cover the active commercial sub-markets: Oxford City Centre and Carfax (OX1 prime retail and hospitality), Jericho and North Oxford (OX2 premium professional services), Headington (OX3 hospital, healthcare and retail), Cowley Road and East Oxford (OX4 independent retail and HMO), Summertown (OX2 affluent retail and professional), Botley and Westway (OX2 district retail and regeneration), Iffley and Iffley Road (OX4 leisure and HMO), Marston (OX3 suburban healthcare and retail), Littlemore and Blackbird Leys (OX4 outer trade and healthcare), Oxford Science Park (OX4 office, lab and investment), Begbroke and Oxford North (OX5 innovation district), Westgate and Oxford Castle Quarter (OX1 retail and leisure flagship). Beyond the city itself we routinely fund deals across Oxfordshire and the South East England commuter belt, Bicester, Witney, Abingdon, Didcot, Banbury, Kidlington, Thame and Wallingford, from the same Oxford-based lender panel.`,
    relatedLinks: [
