/**
 * Service catalogue, Commercial Mortgages Oxford.
 *
...
Lender underwriting tests EBITDA cover (trading profit against the mortgage payment) at 1.3–1.5×, with two years of clean filed accounts the standard minimum. In Oxford the typical owner-occupier facility is £150K–£3M, with the bulk of volume in the £500K–£1.5M bracket. Loan-to-value of 70–75% is routine for established businesses; deposits of 25–30% from accumulated retained profit are standard. Interest rates currently 6.0–7.5% pa for strong covenants, stretching to 9.0% for tighter cases.
...
This is unregulated commercial lending in almost all cases, a business borrowing against business premises, not a residential mortgage. Owner-occupier commercial mortgages fall outside the Financial Conduct Authority's regulated mortgage perimeter; where a deal would require regulated permissions we refer to a regulated firm. Active sectors in Oxford: dental and GP practices (Summertown and Headington clusters), accountancy and professional services, life-sciences and lab-enabled offices (Oxford Science Park, Begbroke and Oxford North), light industrial and trade-counter (Cowley and the Eastern Bypass corridor), pharmacy. Sector-specialist trades, care home, MOT, nursery, route through trading-business mortgages.`,
    keyFeatures: [
...
Active Oxford investment areas: city-centre office and retail around Carfax and Westgate, Cowley Road semi-commercial parades, Jericho and Walton Street creative offices, the Oxford Science Park life-sciences cluster and the Cowley industrial belt. Pricing currently 6.5–8.5% pa depending on covenant and LTV. Commercial investment lending is unregulated and sits outside the regulated mortgage perimeter in almost all cases.`,
    keyFeatures: [
    ...
    suitableFor: [
      "Investors buying let offices in central Oxford",
      "Landlords acquiring let retail (Westgate, Castle Quarter, suburban parades)",
      "Industrial investors (Cowley, Eastern Bypass, Oxford Science Park)",
  ...
  },
  {
    ...
    fullDescription: `Semi-commercial is the term for finance against mixed-use property where the residential element is at least 40% of total floorspace, typically the classic shop-with-flat-above archetype that defines Oxford high streets. The product gives lenders comfort from the residential security, so semi-commercial routinely prices 50–100bps inside pure commercial investment.
...
Specialist lenders dominate this market. InterBay Commercial (OSB Group), Shawbrook, LendInvest, Together, Aldermore, Hampshire Trust Bank and Cambridge & Counties all run active programmes for Oxford semi-commercial deals between £150K and £2M. Stamp duty land tax follows non-residential rates on a genuinely mixed-use property, materially cheaper than residential SDLT.

Active Oxford semi-commercial spines: Cowley Road in East Oxford, Walton Street and Walton Crescent in Jericho, Banbury Road in Summertown, London Road in Headington, the Westgate quarter, and the Iffley Road corridor. Most semi-commercial lending is unregulated and sits outside the regulated mortgage perimeter, the exception is where the borrower personally occupies one of the residential flats, which falls into regulated territory and we refer to a regulated firm.`,
    keyFeatures: [
      ...
      "Interest rates from 7.5% pa",
      "5–25 year repayment terms",
      "Active across all Oxford high-street parades",
    ],
    typicalTerms: [
      { label: "LTV", value: "Up to 75%" },
      { label: "Rate", value: "From 7.5% pa" },
...
Aggregate ICR is tested across the portfolio at 140–150%. Tenant concentration matters, if more than 20–25% of income comes from a single tenant, lenders may price wider or cap loan-to-value. Most Oxford portfolio refinancing is taken out by a limited company holding structure (single corporate-level entity, or topco with subsidiary SPVs). Stamp duty land tax does not apply on a refinance (no transfer of ownership), which is part of why consolidation maths can work even when ERCs are in the model.

Shawbrook, Cambridge & Counties, InterBay Commercial and Cynergy Bank are the most active portfolio lenders for the £2M–£15M Oxford bracket. OakNorth and Reliance Bank cover larger. Portfolio refinancing is unregulated commercial lending and sits outside the regulated mortgage perimeter.`,
    keyFeatures: [
    ...
    suitableFor: [
      "Oxford-based commercial landlords with 5+ investment properties",
      "Oxfordshire portfolio holders consolidating off multiple bank relationships",
...
Different lenders dominate different sub-sectors: Cynergy Bank and ASK Partners on pubs; Shawbrook, Cambridge & Counties and Hampshire Trust on care; Hampshire Trust and Allica on dental; Together on MOT/garage; Aldermore and Cambridge & Counties on nursery. Refinancing existing trading-business mortgages (typically off a maturing 5-year fix) is a frequent reason to re-engage. Trading-business commercial lending is unregulated and sits outside the regulated mortgage perimeter, not a residential mortgage.`,
    ...
    suitableFor: [
      "Pub and bar operators (central Oxford, Jericho, market-town Oxfordshire)",
      "Hotel and B&B operators",
      "Care home operators (Headington and North Oxford premium cluster)",
...
For end-of-fix transitions, the underwriting story is usually clean, known asset, known borrower, known repayment track record. Pricing competition between NatWest, Lloyds, Barclays, Santander, Shawbrook, Allica, HTB Oxford, Cambridge & Counties and InterBay Commercial is real, even a 50bps move on a £1M facility saves £5,000 a year. Loan-to-value to 75%; interest rates from 7.0% pa for strong owner-occupier remortgaging.

Most Oxford remortgaging is taken out by a limited company SPV or trading entity. Owner-occupier and investment commercial remortgaging both sit outside the regulated mortgage perimeter in standard cases, unregulated commercial lending throughout.`,
    keyFeatures: [
      "Whole-of-market benchmark across 90+ lenders",
...
LendInvest, Shawbrook, Together, OakNorth and Hampshire Trust Bank are the most active bridging desks for the Oxford £500K–£5M bracket. Bridge interest rates currently run 0.70–0.95% pm (8.5–11.5% pa equivalent); term-out pricing back to mainstream 6.5–8.5% pa once the property stabilises. Repayment is typically interest-only across the bridge period (serviced monthly or rolled-up) then full capital-and-interest on the term-out. Loan-to-value to 70% on current value; sometimes 75% on day-one purchase price plus 100% of refurb costs against GDV.
...
Where this works particularly well in Oxford: vacant OX1 and OX2 office floorplates being refurbished for re-letting; semi-commercial conversions on the Cowley Road and Walton Street spines; industrial units in Cowley and Botley bought from receivers; trading businesses bought as going concerns where the new operator needs 12 months of accounts before high-street remortgage. Commercial bridging on business property is unregulated and sits outside the regulated mortgage perimeter, where a deal would require regulated permissions, we refer to a regulated firm.`,
    keyFeatures: [
