/**
 * Testimonials, Commercial Mortgages Oxford.
 *
...
export const testimonials: Testimonial[] = [
  {
    quote:
      "Quoted 8.95% pa over 15 years on the OX2 surgery freehold by my own commercial bank. Matt benchmarked four dental-active lenders, came back at 6.85% over 20 years, and completed inside the vendor's 60-day window. The longer term was the unlock, EBITDA cover went from a tight 1.28x to a comfortable 1.51x. No surprises at credit committee.",
    author: "Dr A. Patel",
