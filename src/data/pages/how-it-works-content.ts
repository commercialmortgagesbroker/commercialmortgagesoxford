/**
 * /how-it-works page content, Commercial Mortgages Oxford.
 *
...
export const howItWorksContent: HowItWorksContent = {
  hero: {
    h1: "How an Oxford commercial mortgage actually completes",
    lede:
      "Five steps from initial enquiry to completion and drawdown. Indicative terms inside two business hours. RICS Red Book valuation in week two or three. Solicitor instruction in parallel. Funds drawn at completion in 4 to 8 weeks for clean owner-occupier and investment deals; 6 to 10 weeks where the sector underwrite needs more work, such as an Oxford Science Park lab investment or a central Oxford hotel refinance.",
  },

  intro: {
    h2: "Commercial mortgage in one paragraph",
    body: [
      'A commercial mortgage is <strong>long-term debt secured against income-producing or owner-occupied commercial property</strong>. In the Oxford market for mid-2026, facilities are typically structured at 65 to 75 percent LTV across 5 to 25 year terms, with monthly capital and interest payments. Rates run 6.0 to 9.0 percent pa depending on product, sector, LTV and covenant strength. Arrangement fees usually 1 to 2 percent of the facility, RICS Red Book valuation 1,500 to 8,000 pounds depending on asset complexity (Oxford Science Park lab-enabled office valuations sit at the top of that band), and legal fees both sides.',
    ...
    items: [
      {
        ...
        detail:
          "Two years of clean filed accounts is the typical minimum. Specialists flex to 12 to 18 months in defensive regulated sectors, dental, GP, pharmacy, established trades.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Gross rent against interest cost at 140 to 160 percent stressed at a notional rate 1 to 2 percent above the pay rate. Strong tenant covenant on a long lease prices best, life-sciences tenants on long FRI leases at Oxford Science Park and Begbroke underwrite particularly cleanly.",
      },
      {
        label: "Deposit",
        detail:
      ...
      },
      {
        ...
        detail:
          "CQC rating Good or above for care, Ofsted Good or above for nursery, VOSA approval for MOT, NHS contract for dental, occupancy and ADR for hotel, barrelage and EBITDA for pub.",
      },
      {
  ...
  timeline: {
    h2: "How long does an Oxford commercial mortgage take?",
    body:
      'From a clean enquiry through to completion and drawdown: <strong>4 to 8 weeks</strong> for mainstream owner-occupier, commercial investment and semi-commercial. <strong>6 to 10 weeks</strong> for trading-business cases (care home, hotel, pub, MOT) and Oxford Science Park lab investment cases reflecting the sector-specialist underwrite, environmental due diligence and specialist RICS valuation. The critical-path item is almost always the RICS Red Book valuation. The fastest clean owner-occupier completion on our recent record was <strong>24 working days</strong>, a Jericho professional firm freehold purchase where the borrower had two years of clean accounts ready, the solicitor moved quickly on enquiries, and the lender had recent comparable approvals on file at the same Thames Valley valuer.',
  },
};
